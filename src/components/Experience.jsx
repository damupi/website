...
export default function Experience() {
  return (
    <section id="experience" className="py-16 border-t border-light-border dark:border-dark-border">
            ...
            >
              {company.logo ? (
                ...
                <div className="h-8 mb-3 flex items-center">
                  <span className="text-xs uppercase tracking-widest text-light-border dark:text-dark-border border border-light-border dark:border-dark-border rounded px-2 py-0.5">
                    {company.name}
                  </span>
                </div>
              )}
