  ...
  return (
    <footer className="border-t border-light-border dark:border-dark-border py-10">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 flex flex-col items-center gap-4">
        ...
        <p className="text-light-muted dark:text-dark-muted text-sm italic">Love me or hate me, but mean it.</p>
        <p className="text-light-border dark:text-dark-border text-xs">&copy; {new Date().getFullYear()} damupi</p>
      </div>
    </footer>
  )
}
